...
$(function () {
  function MyCustomViewModel(parameters) {
    ...
    self.getAdditionalControls = function () {
      ...
      var baseSettings = [
        {
          ...
          children: [
            ...
            },
            {
              ...
              commands: [],
              customClass: "btn",
              additionalClasses: "btn-danger nowrap",
              name: "Apply Heat",
            },
            {
              width: "7",
      ...
      if (settings.autolevel()) {
        ...
        if (autolevel.indexOf("\n") == -1) {
          baseSettings[0].children.splice(4, 0, {
            width: "7",
            command: autolevel,
            customClass: "btn",
    ...
    function waitForHeat(currentSettings) {
      ...
      heatCommand.push(
        "M190 S" + settings.bed_temp(),
        "M109 S" + settings.nozzle_temp()
      );
    }
